...
//向服务器发送消息
	[Message(OuterMessage.C2G_HelloWorldSend)]
	[ProtoContract]
	public partial class C2G_HelloWorldSend: ProtoObject, IMessage
	{
		[ProtoMember(1)]
		public int RpcId { get; set; }
...
//向服务器请求消息
	[ResponseType(nameof(G2C_HelloWorld))]
	[Message(OuterMessage.C2G_HelloWorld)]
	[ProtoContract]
	public partial class C2G_HelloWorld: ProtoObject, IRequest
	{
		[ProtoMember(1)]
		public int RpcId { get; set; }
...
//服务器回应消息
	[Message(OuterMessage.G2C_HelloWorld)]
	[ProtoContract]
	public partial class G2C_HelloWorld: ProtoObject, IResponse
	{
		[ProtoMember(1)]
		public int RpcId { get; set; }
	...
	public static class OuterMessage
	{
		 ...
		 public const ushort C2G_HelloWorldSend = 10036;
		 public const ushort C2G_HelloWorld = 10037;
		 public const ushort G2C_HelloWorld = 10038;
	}
}
